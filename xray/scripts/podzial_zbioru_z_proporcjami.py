...
ORIGINAL_DATA_DIR = Path(r'C:\Users\jakub\OneDrive\Pulpit\studia semestr 5\zaawansowane metody i techniki AI\laboratorium\Zaawansowane-metody-SI\xray\chest_xray')

# Gdzie zapisać NOWY podział (stworzy ten folder)
NEW_SPLIT_DIR = Path(r'C:\Users\jakub\OneDrive\Pulpit\studia semestr 5\zaawansowane metody i techniki AI\laboratorium\Zaawansowane-metody-SI\xray\chest_xray_val500')
